...
var mainFunction = function(projectName) {
...
if(process.argv[2]===undefined) {
  exec("zenity --entry --title=I3 --text='Start a new project with the name:'", function(error1, stdout1, stderr1) {
    mainFunction(stdout1);
  });
} else {
